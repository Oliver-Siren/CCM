...
My Salt research has been used and studied for evaluating the benefits of Salt in two projects, coinciding with our Arctic CCM project: a smart mirror ([Kuvastin](https://kuvastinblog.wordpress.com/)) project and the Campfire occupation monitor ([Nuotiovahti](https://raspluonto.wordpress.com/)) project. 

The mirror project was sponsored by the smartphone manufacturer OnePlus.

The Campfire project was conceived as a part of the three years long Virtual Nature development, that is run by [Lahti University of Applied Sciences](http://www.lamk.fi/english/Sivut/default.aspx)
